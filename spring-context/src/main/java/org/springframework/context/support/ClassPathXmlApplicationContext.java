...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	public ClassPathXmlApplicationContext(
		...
		//加载application.xml的入口
		super(parent);  //最终跳到父类AbstractApplicationContext，为容器设置好Bean资源加载器

		//调用父类AbstractRefreshableConfigApplicationContext的setConfigLocations方法
		setConfigLocations(configLocations);

		if (refresh) {
			refresh(); //调用父类AbstractApplicationContext的refresh方法
		}
	}
